...
/**
 * list_len - calcultes length of linked list
 * @h: pointer is reference to the initial node
 *
...
/**
 * print_list - prints all elements within a linked list of type list_t.
 * @h: pointer is reference to the initial node
 *
 * Return: list magnitude
 */
 ...
 *
 * Return: either match the node or return null
 */
