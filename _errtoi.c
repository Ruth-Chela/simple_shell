 ...
 * @s: the str that will be changed
 * Return: 0 if no num in str, changed number otherwise
 *       -1 on error
 */
int _erratoi(char *s)
{
...
/**
 * print_d - the function outputs a decimal (integer) number in base 10
 * @input: the provided input
 * @fd: the fd that should be written
 *
...
/**
 * convert_number - the conversion function, a replica of the itoa function
 * @num: number
 * @base: base
 * @flags: arg flags
 *
